           ...
           <div className="contact-con">
                ...
                <div className='footer-con'>
                    <div className='contact-info'>
                        <div>
                             <img src={call} alt='call'/><span>+91 8618976974</span>
                        </div>
                        <div>
                             <img src={insta} alt='call'/><span></span>
                        </div>
                        <div>
                             <img src={mail} alt='call'/><span>thebingein90@gmail.com</span>
                        </div>
                    ...
                    <div className='address'>
                        <div>
                             <img src={location} alt='call'/><span>Official Address<br/>2nd floor, Plot # 67, Vivekananda Nagar Rd,<br/>Chitraseema Nagar, Mansoorabad Rd,<br/>Mansoorabad,Telangana 500070</span>
                        </div>
                    </div>
